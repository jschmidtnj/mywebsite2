<template>
  <div id="privacy">
    ...
    <p>
      Like most website operators, Joshua Schmidt collects
      ...
      Joshua Schmidt's purpose in collecting non-personally identifying
      information is to better understand how Joshua Schmidt's visitors use its
      website. From time to time, Joshua Schmidt may release
    ...
    <p>
      Certain visitors to Joshua Schmidt's websites choose to interact with
      Joshua Schmidt in ways that require Joshua Schmidt to gather
    ...
    <p>
      ...
      Privacy Policy covers the use of cookies by Joshua Schmidt and does not
    ...
    <p>
      Joshua Schmidt discloses potentially personally-identifying and
      personally-identifying information only to those of its employees,
      contractors and affiliated organizations that (i) need to know that
      information in order to process it on Joshua Schmidt's behalf or to
      provide services available at Joshua Schmidt's website, and (ii) that have
      agreed not to disclose it to others. Some of those employees, contractors
      and affiliated organizations may be located outside of your home country;
      by using Joshua Schmidt's website, you consent to the transfer of such
      information to them. Joshua Schmidt will not rent or sell potentially
      ...
      described above, Joshua Schmidt discloses potentially
      ...
      Joshua Schmidt believes in good faith that disclosure is reasonably
      necessary to protect the property or rights of Joshua Schmidt, third
    ...
    <p>
      Joshua Schmidt may collect statistics about the behavior of visitors to
      its website. Joshua Schmidt may display this information publicly or
      provide it to others. However, Joshua Schmidt does not disclose your
      personally-identifying information.
    </p>

    <h2>Cookies</h2>
    <p>
      To enrich and perfect your online experience, Joshua Schmidt uses
    ...
    <p>
      ...
      settings, you hereby acknowledge and agree to Joshua Schmidt's use of
      cookies.
    </p>

    <h2>Privacy Policy Changes</h2>
    <p>
      Although most changes are likely to be minor, Joshua Schmidt may change
      its Privacy Policy from time to time, and in Joshua Schmidt's sole
      discretion. Joshua Schmidt encourages visitors to frequently check this
